/* KantorCore icons — Lucide subset, inlined.
   Usage: <i data-icon="search"></i>  →  inline SVG with .kc-icon class.
   1.5px stroke, 24px viewBox, currentColor. */
(function () {
  const I = {
    // navigation
    ...
    'check-circle':'<circle cx="12" cy="12" r="9"/><polyline points="9 12 11 14 15.5 9.5"/>',
    ...
    'pivot':      '<rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><polyline points="14 14 17 17 21 14"/>',
    // modules
    'home':       '<path d="M3 12 12 4l9 8"/><path d="M5 10v10a1 1 0 0 0 1 1h4v-7h4v7h4a1 1 0 0 0 1-1V10"/>',
    ...
    'wallet':     '<rect x="2" y="6" width="20" height="14" rx="2"/><path d="M22 11h-4a2 2 0 0 0 0 4h4"/>',
    'invoice':    '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="14" x2="15" y2="14"/><line x1="9" y1="18" x2="13" y2="18"/>',
    ...
    'project':    '<rect x="3" y="3" width="7" height="9"/><rect x="14" y="3" width="7" height="5"/><rect x="14" y="12" width="7" height="9"/><rect x="3" y="16" width="7" height="5"/>',
    'clock':      '<circle cx="12" cy="12" r="9"/><polyline points="12 7 12 12 15 14"/>',
    'receipt':    '<path d="M4 2v20l3-2 3 2 3-2 3 2 3-2 3 2V2l-3 2-3-2-3 2-3-2-3 2-3-2z"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="14" y2="13"/>',
    ...
    'help':       '<circle cx="12" cy="12" r="9"/><path d="M9.5 9.5a2.5 2.5 0 1 1 3.5 2.3c-.6.3-1 .8-1 1.5V14"/><circle cx="12" cy="17" r="0.5" fill="currentColor"/>',
    ...
    'eye-off':    '<path d="M17.94 17.94A10.06 10.06 0 0 1 12 20c-7 0-11-8-11-8a18.5 18.5 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/>',
    ...
    // AI
    'sparkles':   '<path d="M12 3l1.6 4.4L18 9l-4.4 1.6L12 15l-1.6-4.4L6 9l4.4-1.6z"/><path d="M19 14l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8z"/><path d="M5 17l.5 1.5L7 19l-1.5.5L5 21l-.5-1.5L3 19l1.5-.5z"/>',
    ...
    'bot':        '<rect x="3" y="11" width="18" height="10" rx="2"/><circle cx="12" cy="5" r="2"/><path d="M12 7v4"/><line x1="8" y1="16" x2="8" y2="16.01"/><line x1="16" y1="16" x2="16" y2="16.01"/>',
    'play':       '<polygon points="6 4 20 12 6 20 6 4"/>',
    'pause':      '<rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/>',
    'refresh':    '<polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/>',
    'history':    '<polyline points="3 12 6 9 9 12"/><path d="M6 9v6a6 6 0 1 0 12 0"/><polyline points="12 7 12 11 15 11"/>',
    ...
    'pin':        '<line x1="12" y1="17" x2="12" y2="22"/><path d="M5 17h14v-1.76a2 2 0 0 0-1.11-1.79l-1.78-.9A2 2 0 0 1 15 10.76V6h1V3H8v3h1v4.76a2 2 0 0 1-1.11 1.79l-1.78.9A2 2 0 0 0 5 15.24Z"/>',
  ...
  function svg(name) {
    const body = I[name];
    if (!body) return '';
    return `<svg class="kc-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${body}</svg>`;
  }
  function mount(root) {
    root = root || document;
    root.querySelectorAll('[data-icon]').forEach(el => {
      ...
      if (out) {
        ...
        // copy size hint classes
        if (el.classList.length) node.classList.add(...el.classList);
        if (el.style.cssText) node.style.cssText = el.style.cssText;
        el.replaceWith(node);
      }
    });
  }
  window.kcIcon = svg;
  window.kcMountIcons = mount;
